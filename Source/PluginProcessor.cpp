...
//==============================================================================
const juce::String ZeroEQAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool ZeroEQAudioProcessor::acceptsMidi() const
{
...
bool ZeroEQAudioProcessor::producesMidi() const
{
...
bool ZeroEQAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double ZeroEQAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int ZeroEQAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int ZeroEQAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void ZeroEQAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void ZeroEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool ZeroEQAudioProcessor::hasEditor() const
{
...
void ZeroEQAudioProcessor::updatePeakFilter(const ChainSettings &chainSettings)
{
...
void ZeroEQAudioProcessor::updateLowCutFilters(const ChainSettings &chainSettings)
{
...
void ZeroEQAudioProcessor::updateHighCutFilters(const ChainSettings &chainSettings)
{
...
void ZeroEQAudioProcessor::updateFilters()
{
...
juce::AudioProcessorValueTreeState::ParameterLayout
    ZeroEQAudioProcessor::createParameterLayout()
{
